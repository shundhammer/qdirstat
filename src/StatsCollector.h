...
namespace QDirStat
{
    ...
    /**
     * Helper class for extended statistics to collect data for a subtree.
     *
     ...
     * stored for each file (or each matching file) is stored in this object,
     * so this is expensive in terms of memory usage. Also, since data usually
     * need to be sorted for those calculations and sorting has at least
     * logarithmic cost O( n * log(n) ), this also has heavy performance
     * impact.
     **/
